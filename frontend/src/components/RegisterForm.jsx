  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (adminComplejo) {
        ...
        // Guardamos la sesión de inmediato (como en el login) para
        // que RegisterComplexForm sepa a qué usuario asociar el
        // complejo que va a registrar a continuación.
        const usuarioNuevo = {
        ...
        navigate("/register-success-client");
